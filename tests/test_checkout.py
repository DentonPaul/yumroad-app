...
DUMMY_CUSTOMER_ID = "cus_IfYqfneKfJBMjg"
TEST_CUSTOMER_EMAIL = "dentongpaul@gmail.com"
...
# @vcr.use_cassette('tests/cassettes/test_get_customer.yaml',
#                   filter_headers=['authorization'], record_mode='once')
def test_event_webhook(app, init_database, user_with_product, client): # additional arg: 'mail_outbox' fixture
